INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Bruno', 'Barbieri', 'Sono uno chef italiano di fama mondiale, conosciuto per aver guadagnato 7 stelle Michelin nel corso della mia carriera. Ho aperto diversi ristoranti di successo, tra cui il celebre Fourghetti a Bologna. Sono anche un giudice storico di MasterChef Italia e autore di numerosi libri di cucina.', '1962-01-12', '{/images/cuochi/Bruno-Barbieri.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Antonino', 'Cannavacciuolo', 'Sono uno chef italiano rinomato per la mia cucina che unisce tradizione e innovazione. Gestisco il ristorante Villa Crespi, premiato con due stelle Michelin, e sono conosciuto al grande pubblico come giudice di MasterChef Italia.', '1975-04-16', '{/images/cuochi/Antonino-Cannavacciuolo.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Daniel', 'Boulud', 'Sono uno chef francese di fama internazionale, noto per il mio ristorante Daniel a New York, che ha ottenuto tre stelle Michelin. Sono orgoglioso di essere uno dei più rispettati ambasciatori della cucina francese nel mondo.', '1955-03-25', '{/images/cuochi/Daniel-Boulud.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Enrico', 'Bartolini', 'Sono uno chef italiano pluripremiato, unico a detenere 9 stelle Michelin con i miei ristoranti. La mia cucina è nota per essere raffinata e creativa, valorizzando sempre i sapori della tradizione italiana.', '1979-03-20', '{/images/cuochi/Enrico-Bartolini.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Enrico', 'Crippa', 'Sono uno chef italiano rinomato per la mia cucina innovativa e artistica. Guardo il ristorante Piazza Duomo ad Alba, premiato con tre stelle Michelin, dove cerco di esprimere la mia passione per l’arte culinaria.', '1971-11-15', '{/images/cuochi/Enrico-Crippa.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Heinz', 'Beck', 'Sono uno chef tedesco di fama mondiale, noto per la mia cucina raffinata e creativa. Sono il capo chef del ristorante La Pergola a Roma, premiato con tre stelle Michelin, dove metto tutta la mia passione e competenza.', '1963-11-03', '{/images/cuochi/Heinz-Beck.jpeg}');
INSERT INTO cuoco (id, nome, cognome, descrizione, data_di_nascita, urls_images) VALUES(nextval('cuoco_seq'), 'Riccardo', 'Monco', 'Sono uno chef italiano appassionato e dedito alla tradizione toscana. Guardo l Enoteca Pinchiorri a Firenze, premiata con tre stelle Michelin, dove la mia abilità culinaria trova la sua massima espressione.', '1969-02-19', '{/images/cuochi/Riccardo-Monco.jpeg}');

INSERT INTO ricetta (id, nome, descrizione, cuoco_id, urls_images) VALUES(nextval('ricetta_seq'), 'Carbonara Vegetariana', 'La nostra Carbonara Vegetarian è una rivisitazione leggera e gustosa del classico romano. Spaghetti al dente si fondono con una crema vellutata di uova e pecorino, arricchita da croccanti cubetti di zucchine e carote. Un tocco di pepe nero fresco completa il piatto, offrendo un equilibrio perfetto tra sapore e leggerezza.', (SELECT id FROM cuoco WHERE nome = 'Enrico' AND cognome = 'Bartolini'), '{/images/ricette/CarbonaraVegetariana.jpeg}');
INSERT INTO ricetta (id, nome, descrizione, cuoco_id, urls_images) VALUES(nextval('ricetta_seq'), 'Dolce Prato', 'Il Dolce Prato è un dessert raffinato che celebra i sapori della tradizione toscana. Una base soffice di pan di spagna è arricchita da una crema di ricotta e frutti di bosco freschi. La nota di vin santo conferisce un tocco di eleganza, trasformando ogni morso in un esperienza sensoriale unica.', (SELECT id FROM cuoco WHERE nome = 'Riccardo' AND cognome = 'Monco'), '{/images/ricette/DolcePrato.jpeg}');
INSERT INTO ricetta (id, nome, descrizione, cuoco_id, urls_images) VALUES(nextval('ricetta_seq'), 'Panna Cotta Matisse', 'La Panna Cotta Matisse è un dolce che unisce arte e gusto. La panna cotta, morbida e setosa, è decorata con uno strato di gelatina ai frutti di bosco che crea un contrasto di colori e sapori. Una spolverata di fiori commestibili aggiunge un tocco di raffinatezza, rendendo questo dessert un vero capolavoro.', (SELECT id FROM cuoco WHERE nome = 'Enrico' AND cognome = 'Crippa'), '{/images/ricette/PannaCottaMatisse.jpeg}');
INSERT INTO ricetta (id, nome, descrizione, cuoco_id, urls_images) VALUES(nextval('ricetta_seq'), 'Papouitte di Pesce', 'La Papouitte di Pesce è un piatto che cattura l essenza del mare. Filetti di pesce freschissimi sono avvolti in una leggera sfoglia e cotti al vapore per preservarne la delicatezza. Un emulsione di agrumi e finocchio completa il piatto, esaltando la freschezza e la semplicità degli ingredienti.', (SELECT id FROM cuoco WHERE nome = 'Daniel' AND cognome = 'Boulud'), '{/images/ricette/PapouittePesce.jpeg}');
INSERT INTO ricetta (id, nome, descrizione, cuoco_id, urls_images) VALUES(nextval('ricetta_seq'), 'Uovo Cocotte', 'Uovo Cocotte è un antipasto elegante e raffinato. L uovo, cotto alla perfezione in un bagno di panna e tartufo nero, è servito con una croccante baguette tostata. Ogni boccone è un esplosione di sapori, dove la cremosità dell uovo si sposa con l intensità del tartufo.', (SELECT id FROM cuoco WHERE nome = 'Bruno' AND cognome = 'Barbieri'), '{/images/ricette/UovoCocotte.jpeg}');
...
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Pecorino Romano'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), '50 gr');
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Uova'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), '2 uova');
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Pepe Nero'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), 'q.b.');
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Carote'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), '100 gr');
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Zucchine'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), '100 gr');
INSERT INTO riga_ricetta (id, ingrediente_id, ricetta_id, quantita) VALUES (nextval('riga_ricetta_seq'), (SELECT id FROM ingrediente WHERE nome = 'Spaghetti'), (SELECT id FROM ricetta WHERE nome = 'Carbonara Vegetariana'), '200 gr');
